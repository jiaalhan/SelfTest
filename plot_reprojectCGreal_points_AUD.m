function []=plot_reprojectCGreal_points_AUD(CBimagesInfo,cameraCBparameters)
...
imagePoints = cameraCBparameters.imagePointsAUD;
index = 1:size(cameraCBparameters.imagePointsAUD,3);
r= [];
...
icount=0;
for iplot=imageIndecesToDisplay
    icount=icount+1;
    %plot
